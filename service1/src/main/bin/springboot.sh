...
GIT_BRANCH=master
#应用的仓库名称
GIT_PROJECT_NAME=cloud-framework
#应用名称
APP_NAME=tenant
...
#jvm参数-堆
JAVA_OPTS="-server -Xms2048m -Xmx2048m -XX:NewRatio=2 -XX:SurvivorRatio=6 -Xss256k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=256m"
#jvm参数-GC
